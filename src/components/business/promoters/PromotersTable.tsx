...
import { HandCoins, Edit, Trash2, ShieldCheck, ShieldX } from "lucide-react";
...
export function PromotersTable({ promoters, onToggleStatus, onRegisterPayment, onEditLink, onDeleteLink, isSubmitting }: PromotersTableProps) {
