        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li><a href="tel:+51942401695" className="hover:text-white transition-colors">+51 942 401 695</a></li>
              <li><a href="mailto:hola@sociovip.pe" className="hover:text-white transition-colors">hola@sociovip.pe</a></li>
