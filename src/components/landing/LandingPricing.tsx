...
const plans = [
  {
    ...
    features: [
      ...
      "1 promoción activa",
      "Acceso al directorio de SOCIO VIP",
  ...
  },
  {
    name: "Pro",
    price: 199,
    desc: "Para negocios que quieren crecer con datos.",
    features: [
      "Todo lo del plan Básico",
      "Eventos ilimitados con QR de acceso",
      "Analítica de clientes (dashboard)",
      "Segmentación por perfil de usuario",
      "Recomendaciones vía Concierge IA",
      "Soporte prioritario",
    ],
    cta: "Solicitar Demo",
    highlighted: true,
  },
  {
    name: "Premium",
    price: 399,
    desc: "La experiencia completa para líderes del sector.",
    features: [
      "Todo lo del plan Pro",
      "IA personalizada para tu negocio",
      "Publicidad destacada en el Concierge",
      "Integraciones y API access",
      "Reportes exportables mensuales",
