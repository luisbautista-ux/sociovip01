...
export default function PromoterDashboardPage() {
  ...
  if (loadingAuth || loadingProfile || isLoading) {
    return (
      <div className="flex justify-center items-center h-[calc(100dvh-150px)]">
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-gradient flex items-center gap-2 mb-6">
        <BarChart2 className="h-8 w-8 text-primary !block" />
        Dashboard
      </h1>
        ...
        <Card className="shadow-lg">
          <CardContent className="p-4 space-y-4">
             <div className="space-y-4">
                ...
                <StatCard title="QRs generados con tus códigos" value={promoterStats.qrGeneratedWithPromoterCodes} icon={ScanLine} iconColor="text-blue-600" />
