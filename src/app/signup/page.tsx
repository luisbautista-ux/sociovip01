...
export default function SignupPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#f4eef7] p-4 flex items-center justify-center">
      <Link href="/" className="z-10 absolute left-4 top-4 md:left-8 md:top-6 group">
          <span className="inline-flex items-center gap-1.5 text-sm md:text-base font-semibold text-gradient bg-gradient-to-r from-purple-800 to-red-600 text-transparent bg-clip-text group-hover:opacity-90 transition-opacity">
