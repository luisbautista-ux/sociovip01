...
const QR_READER_ELEMENT_ID = "qr-reader-validator-biz";
...
export default function BusinessPanelValidateQrPage() {
  ...
  const fetchActiveEntities = React.useCallback(async () => {
    ...
    try {
      ...
      // Aquí filtramos las que están vigentes para mostrar en la lista
          ...
          <CardContent className="space-y-4">
            {validationResult.type === 'not_found' ? (
              ...
              <div className="space-y-4">
                {/* Alerta de Éxito / Error de Tiempo / Error de Uso */}
                  ...
                  <div className="ml-2">
                    ...
                    <AlertDescription className={(alreadyUsedToday || isNoSession || isOutsideTime) ? "text-red-700" : "text-green-700"}>
                        {alreadyUsedToday ? `El cliente ya ingresó a la sesión: ${currentSchedule?.label || 'General'}.` : 
                         isNoSession ? "No hay una sesión activa de este evento en este momento. Verifique los horarios." :
